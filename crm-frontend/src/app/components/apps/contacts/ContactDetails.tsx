	...
	const tableData = [
		{
			id: 1,
			title: 'Firstname',
			alias: 'firstname' as const,
			gdata: contactDetail.firstname,
			type: 'text' as const,
		},
		{
			id: 2,
			title: 'Lastname',
			alias: 'lastname' as const,
			gdata: contactDetail.lastname,
			type: 'text' as const,
		},
		{
			id: 3,
			title: 'Company',
			alias: 'company' as const,
			gdata: contactDetail.company,
			type: 'text' as const,
		},
		{
			id: 4,
			title: 'Department',
			alias: 'department' as const,
			gdata: contactDetail.department,
			type: 'text' as const,
		},
		{
			id: 5,
			title: 'Email',
			alias: 'email' as const,
			gdata: contactDetail.email,
			type: 'email' as const,
		},
		{
			id: 6,
			title: 'Phone',
			alias: 'phone' as const,
			gdata: contactDetail.phone,
			type: 'phone' as const,
		},
		{
			id: 7,
			title: 'Address',
			alias: 'address' as const,
			gdata: contactDetail.address,
			type: 'text' as const,
		},
		{
			id: 8,
			title: 'Notes',
			alias: 'notes' as const,
			gdata: contactDetail.notes,
			type: 'text' as const,
		},
	]
								...
								{tableData.map(data => (
									<Box key={data.id} px={3} py={1.5}>
										...
										<TextField
											...
											onChange={e =>
												dispatch(
													UpdateContact(idNum, data.alias, e.target.value)
												)
											}
										/>
									</Box>
